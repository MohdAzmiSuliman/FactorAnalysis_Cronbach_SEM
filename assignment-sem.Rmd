...
summary(exermodparam, fit.measure = T, standardized = T, ci=T)
```
...
Mediation: both direct and indirect effect was significant, thus there was partial mediation effect present
...
```{r}
exermod_semplot <- semPaths(exermodparam, what = "path", whatLabels = "std", layout = "spring", edge.label.cex = 1.2, nDigits = 3, style = "lisrel", nCharNodes = 0, sizeMan = 8, sizeLat = 9, edge.color = "black")
